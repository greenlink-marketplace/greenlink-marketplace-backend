"""
Django settings for greenlink_backend project.
...
SECRET_KEY = 'django-insecure-9o1vk6dhf&c0aqs@u5o1r0pn+866^)ph20elud+y$hzf@+fd(8'
...
WSGI_APPLICATION = 'greenlink_backend.wsgi.application'
